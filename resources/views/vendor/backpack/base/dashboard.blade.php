                ...
                <div class="brand-card">
                  <div class="brand-card-header bg-facebook"><i class="fa fa-facebook"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-1" height="120" style="display: block; height: 96px; width: 435px;" width="543" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
              ...
              <!-- <div class="col-sm-6 col-lg-3">
                <div class="brand-card">
                  <div class="brand-card-header bg-twitter"><i class="fa fa-twitter"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-2" height="120" style="display: block; height: 96px; width: 435px;" width="543" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  <div class="brand-card-body">
                    <div>
              ...
              <!-- <div class="col-sm-6 col-lg-3">
                <div class="brand-card">
                  <div class="brand-card-header bg-linkedin"><i class="fa fa-linkedin"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-3" height="120" style="display: block; height: 96px; width: 435px;" width="543" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  <div class="brand-card-body">
                    <div>
              ...
              <!-- <div class="col-sm-6 col-lg-3">
                <div class="brand-card">
                  <div class="brand-card-header bg-google-plus"><i class="fa fa-google-plus"></i>
                    <div class="chart-wrapper"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                      <canvas id="social-box-chart-4" height="120" style="display: block; height: 96px; width: 435px;" width="543" class="chartjs-render-monitor"></canvas>
                    </div>
                  </div>
                  <div class="brand-card-body">
                    <div>
